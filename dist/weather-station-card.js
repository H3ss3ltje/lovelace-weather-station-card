        ...
        <g class="icon-spin icon-spin-slow" style="transform-origin: 21px 21px">
          ${[0,45,90,135,180,225,270,315].map(e=>K`
              <rect x="18.5" y="5" width="5" height="9" rx="2.5"
                fill="url(#${t}b)"
                transform="rotate(${e} 21 21)"/>
            `)}
          <circle cx="21" cy="21" r="11" fill="url(#${t}s)"/>
