export default {
  ...
  editor: {
    ...
    rainy: "Rainy",
    night: "Night",
    hint: "Tip: set individual tap / hold actions in YAML, e.g. temperature_action:, wind_action:. Sections are hidden automatically when their entity is not configured. Tile order can also be set in YAML under settings.tile_order.",
  },
};
